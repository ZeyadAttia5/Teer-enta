...
import {Table, Button, Modal, Form, Input, Switch, notification, ConfigProvider, Spin, Tooltip, Popconfirm} from 'antd';
import {
    PlusOutlined,
    AppstoreOutlined,
    CheckCircleOutlined,
    FileTextOutlined,
    TagsOutlined, EditOutlined, ExclamationCircleOutlined, DeleteOutlined
...
const ActivityCategories = ({ setFlag }) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (isActive) => (
                <div className="flex items-center">
                    <CheckCircleOutlined className={`mr-2 ${isActive ? 'text-emerald-500' : 'text-gray-400'}`} />
        ...
        },
        {
            ...
            key: 'actions',
            render: (_, record) => (
                user && user.userRole === 'Admin' && user._id === record.createdBy && (
