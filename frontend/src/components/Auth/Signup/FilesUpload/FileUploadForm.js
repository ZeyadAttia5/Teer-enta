...
const FileUploadForm = ({setCertificates, onChange}) => {
  ...
  return (
    <div
      className="flex flex-col items-center w-full max-w-md mx-auto mt-2"
      onDrop={handleDrop}
      onDragOver={handleDragOver}
    >
      <label htmlFor="file" className="cursor-pointer">
        <div className="border-2 border-dashed border-gray-400 p-2 px-16 text-center rounded-lg hover:border-gray-600 transition">
