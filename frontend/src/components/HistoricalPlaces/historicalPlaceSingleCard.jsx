...
const HistoricalPlaceSingleCard = ({ places }) => {
  ...
  return (
    <div className="max-w-sm w-full rounded-lg overflow-hidden shadow-lg bg-white transform hover:bg-[#E2F4C5] hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out m-4">
        <img
