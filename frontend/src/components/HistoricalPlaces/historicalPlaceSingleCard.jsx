        ...
        <div className="p-4 flex flex-col h-[calc(100%-10rem)]">
          ...
          <div className="mt-3">
            <div className="flex flex-wrap overflow-hidden">
              <div className="bg-blue-100 rounded-md px-2 py-1 text-xs font-medium text-blue-600 mr-1 mb-1">
                {places?.location}
              </div>
              ...
              {places?.tags &&
                places?.tags?.map((tag, index) => (
                  <React.Fragment key={tag.name + index}>
                    <span className=" bg-green-100 rounded-md px-2 py-1 text-xs font-medium text-green-600 mr-1 mb-1">
                      {tag.name}
                    </span>
                    <span className=" bg-gray-200 rounded-md px-2 py-1 text-xs font-medium text-gray-400 mr-1 mb-1">
                      {tag.type}
                    </span>
                    <span className=" bg-yellow-100 rounded-md px-2 py-1 text-xs font-medium text-yellow-600 mr-1 mb-1">
