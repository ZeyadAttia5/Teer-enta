...
const ShowHistoricalPlaces = () => {
 ...
 return (
    <div className="max-w-3xl mx-auto mt-10 p-8 pb-10 mb-16 bg-white shadow-lg rounded-lg border border-gray-200 hover:scale-105 hover:bg-[#E2F4C5] transition-transform duration-300 ease-in-out">
