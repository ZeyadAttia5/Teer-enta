...
import {
  getCommentsForTourGuide,
  getRatingsForTourGuide,
} from "../../api/tourGuide.ts";
...
const ItineraryDetails: React.FC = () => {
  ...
  return (
    <div className="flex justify-center">
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 w-[90%]">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            <div className="max-w-7xl mx-auto">
              <div className="space-y-4">
                ...
                >
                  <span className=" text-white">{itinerary.name}</span>
                </Title>
                ...
                <div className="flex flex-wrap justify-between items-center gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      {itinerary.isActive && <Tag color="success">Active</Tag>}
                              ...
                              <div className="bg-white rounded-lg p-4">
                                <div className="flex gap-4">
                                  ...
                                  <div className="flex-grow">
                                    <Text
                                      strong
                                      className="text-lg block text-gray-800 mb-2"
                                    >
                                      {item.activity?.name ||
                                        "Unnamed Activity"}
                                    </Text>
                              ...
                              <div className="p-4">
                                <div className="flex justify-between items-start mb-3">
                                  ...
                                  <Button
                                    ...
                                    onClick={() =>
                                      navigate(
                                        `/itinerary/activityDetails/${item.activity?._id}`
                                      )
                                    }
                                  />
                                </div>
                          ...
                          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 mb-4">
                            <div className="text-center">
                              ...
                              <Text className="text-gray-600">
                                Based on {itinerary.ratings?.length || 0}{" "}
                                reviews
                              </Text>
                            </div>
                          </div>
                                ...
                                <List.Item.Meta
                                  avatar={
                                    <div className="relative">
                                      ...
                                      />
                                      <div className="absolute -bottom-1 -right-1 bg-white rounded-full p-1"></div>
                                    </div>
                                  }
                                  title={
                          ...
                          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 mb-4">
                            <div className="text-center">
                              ...
                              <div className="my-3">
                                <Rate
                                  disabled
                                  value={calculateTourGuideRating()}
                                  allowHalf
