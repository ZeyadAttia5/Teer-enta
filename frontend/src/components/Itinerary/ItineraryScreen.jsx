                    ...
                    {itinerary.name}
                                    ...
                                    description={
                                        <div className="flex flex-col space-y-2"
                                             style={{color: '#496989'}}> {/* Keep the text color consistent */}
                                            <span
                                                className="font-bold text-lg hover:text-[#58A399]">🌐 {itinerary.language}</span>
                                            <span
                                                className="font-bold text-lg hover:text-[#58A399]">💲 {itinerary.price ? `${itinerary.price}` : "N/A"}</span>
                                            <span
                                                className="font-bold text-lg hover:text-[#58A399]">♿ {itinerary.accessibility || "N/A"}</span>
                                            <span
                                                className="font-bold text-lg hover:text-[#58A399]">📍 from: {itinerary.pickupLocation}</span>
                                            <span
                                                className="font-bold text-lg hover:text-[#58A399]">📍 to: {itinerary.dropOffLocation}</span>
                                        </div>
                                    }
                                />
                            </Card>
