      ...
      <div className="flex w-full ml-16">
        <div className="flex w-full">
          <div className="flex flex-col">
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              {!isEditing && (
                <Button
                  type="danger"
                  className="hover:bg-third px-11 py-6 bg-fourth"
              ...
              <Link to="/changePassword">
                <Button
                  type="danger"
                  className="hover:bg-third px-6 py-6 bg-fourth"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
          ...
          <div className="flex justify-center m-8 w-2/3">
            <div className="max-w-xl p-4 bg-fourth border-gray-300 w-full rounded-lg">
