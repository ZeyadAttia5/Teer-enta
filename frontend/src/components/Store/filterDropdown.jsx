...
const FilterDropdown = ({ filters, onFilterChange }) => {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className="absolute bg-[#E2F4C5] shadow-md rounded-lg p-5 min-w-[200px] z-10">
          ...
          <div className="flex flex-col gap-3 mb-3">
            <span className="text-[#496989] font-semibold">Sort by:</span>
            <label className="cursor-pointer text-[#496989]">
              <input
                type="radio"
                value="rating"
          ...
          <button
            className="bg-[#58A399] text-white border-none rounded-md py-1 px-3 cursor-pointer transition-colors duration-300 hover:bg-[#496989]"
            onClick={handleApply}
          >
            Apply
          </button>
