...
const CreateTransportation = () => {
    ...
    const [dropOffLocation, setDropOffLocation] = useState({lat: 26.820553, lng: 30.802498})
    const [pickupLocation, setPickupLocation] = useState({lat: 26.820553, lng: 30.802498})
