...
const Sidebar = ({ visible, onClose }) => {
  ...
  return (
    ...
    >
      <Menu mode="inline" defaultSelectedKeys={[]} className="bg-fourth">
        {user &&
          (user.userRole === "Admin" ||
        ...
        {(user === null ||
          ...
          <Menu.SubMenu
            ...
            classNames={{
              root: "bg-blue-600", // Root submenu custom class
              title: "text-white", // Title of submenu custom class
            }}
          >
        ...
        {(user === null || (user && user.userRole === "Tourist")) && (
          <Menu.SubMenu key="sub8" title="Hotel">
            <Menu.Item key="191" onClick={() => handleClick("/hotel/book")}>
              Book Hotel
            </Menu.Item>
          </Menu.SubMenu>
        )}
